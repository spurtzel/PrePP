...
# def fillDistMatrice(graph): #this is here for new MS constraint
#     index = 0
#     biglist  = [[] for x in graph.nodes()]
#     for i in graph.nodes():
#         mylist = []              
#         for j in graph.nodes():            
#             length = len(nx.shortest_path(graph, i, j, method='dijkstra')) - 1            
#             mylist.append(length) 
#         biglist[index] = mylist    
#         index += 1 
#     return biglist
